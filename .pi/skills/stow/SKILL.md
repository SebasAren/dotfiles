---
name: stow
description: Manage GNU Stow packages — install, uninstall, handle conflicts, add new stowable scripts, and resolve AGENTS.md symlink collisions. Use when installing/uninstalling stow packages, debugging symlink issues, or adding new tools to SebbaFlow.
---

# Stow Skill

GNU Stow management for SebbaFlow. Files in `tool-name/.config/tool/` symlink to `~/.config/tool/` via `stow`.

## When to Use This Skill

- Installing or uninstalling stow packages
- Adding a new tool to SebbaFlow
