...
describe("splitIntoSentences", () => {
	...
	it("handles mixed sentence endings and colons", () => {
		const text = "This is the first thought. Second longer thing here: Third important item! Fourth useful item? Fifth final item.";
		const result = splitIntoSentences(text);
	...
	it("truncates long sentences", () => {
		const text = "This is a very long sentence that exceeds the maximum length limit and should be truncated.";
